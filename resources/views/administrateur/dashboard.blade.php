...
<div class="dashboard">
    ...
    <aside class="sidebar">
        ...
        <!-- FOOTER SIDEBAR AVEC NOM DE L'ADMIN CONNECTÉ ET FORMULAIRE DE DÉCONNEXION -->
        <div class="sidebar-footer" style="display: flex; flex-direction: column; gap: 10px; align-items: flex-start;">
            ...
            <!-- Formulier sécurisé Laravel pour la déconnexion -->
    ...
    <main class="main-content">
        ...
        <section class="welcome">
            <div>
                <!-- Salutation dynamique avec le prénom ou nom -->
        ...
        <section class="stats">
            ...
            <!-- Revenus (Exemple statique conservé ou modifiable de la même façon) -->
        ...
        <section class="actions-alerts">
            ...
            <div class="alerts-box">
                ...
                <div class="alert-item yellow">12 rendez-vous non confirmés</div>
                <div class="alert-item blue-alert">3 médecins en attente</div>
                <div class="alert-item red">6 paiements échoués</div>
            </div>
        </section>
            ...
            <table>
                ...
                <tbody id="appointmentTable">
                    <tr>
                        ...
                        <td><span class="badge success">Confirmé</span></td>
                        <td>
                    ...
                    <div class="doctor-card">
                        ...
                        <div class="doctor-info">
                            ...
                            <div class="doctor-bottom">
                                <span class="active-status">● Actif</span>
                                <button onclick="showDoctor()">Détails</button>
                            </div>
                        </div>
                    </div>
